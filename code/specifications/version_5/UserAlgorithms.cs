    ...
    public static class UserAlgorithms
    {
        ...
        public static void InitScene()
        {
            ...
            StateAccessor.SetState("SceneManager", "Running",
                GameObject.Find("SceneManager"), "Version_5");
        ...
        public static void HandleGreenVialClick()
        {
            ...
            bool cauldronEmpty = StateAccessor.IsState("Cauldron", "Empty", cauldron, "Version_5");
            bool valveOff      = StateAccessor.IsState("GasValve", "Off",   gasValve, "Version_5");

            if (cauldronEmpty && valveOff)
            {
                StateAccessor.SetState("GreenVial", "Poured",  greenVial, "Version_5");
                StateAccessor.SetState("Cauldron",  "Greened", cauldron,  "Version_5");
        ...
        public static void HandleValveClick()
        {
            ...
            bool cauldronGreened = StateAccessor.IsState("Cauldron", "Greened", cauldron, "Version_5");

            if (cauldronGreened)
            {
                StateAccessor.SetState("GasValve", "On", gasValve, "Version_5");

                // Rotate valve 90° around Z to give visual on/off feedback
                if (gasValve != null)
                    gasValve.transform.Rotate(0f, 0f, 90f, Space.Self);
        ...
        public static void HeatCauldron()
        {
            ...
            StateAccessor.SetState("Cauldron", "Heated", cauldron, "Version_5");
        ...
        public static void HandleRedVialClick()
        {
            ...
            bool cauldronHeated = StateAccessor.IsState("Cauldron", "Heated", cauldron, "Version_5");

            if (cauldronHeated)
            {
                StateAccessor.SetState("RedVial",  "Poured", redVial,  "Version_5");
                StateAccessor.SetState("Cauldron", "Primed", cauldron, "Version_5");
        ...
        public static void PickUpIronKey()
        {
            ...
            StateAccessor.SetState("IronKey", "Held", GameObject.Find("IronKey"), "Version_5");
        ...
        {
            heldObjectName = null;
            StateAccessor.SetState("IronKey", "Idle", GameObject.Find("IronKey"), "Version_5");
        ...
        public static void TransmuteKey()
        {
            ...
            StateAccessor.SetState("IronKey", "Transmuted", ironKey, "Version_5");
            if (ironKey != null)
            ...
            {
                bloodstoneKey.transform.position = new Vector3(4f, 8.0f, 0f);
                SetObjectColor("BloodstoneKey", new Color(0.72f, 0.07f, 0.07f)); // vivid blood-red
            }
            StateAccessor.SetState("BloodstoneKey", "Active", bloodstoneKey, "Version_5");
        ...
        public static void PickUpBloodstoneKey()
        {
            ...
            StateAccessor.SetState("BloodstoneKey", "Held", GameObject.Find("BloodstoneKey"), "Version_5");
        ...
        {
            heldObjectName = null;
            StateAccessor.SetState("BloodstoneKey", "Active", GameObject.Find("BloodstoneKey"), "Version_5");
        ...
        public static void OpenTome()
        {
            ...
            StateAccessor.SetState("Tome", "Open", tome, "Version_5");
        ...
        public static void TriggerExplosion()
        {
            ...
            StateAccessor.SetState("Cauldron",  "Failed",  cauldron,  "Version_5");
            StateAccessor.SetState("GreenVial", "Ready",   greenVial, "Version_5");
            StateAccessor.SetState("RedVial",   "Ready",   redVial,   "Version_5");
            StateAccessor.SetState("GasValve",  "Off",     gasValve,  "Version_5");
            ...
            // Reset valve rotation to off position
            if (gasValve != null)
                gasValve.transform.rotation = Quaternion.Euler(0f, 0f, 90f);
            ...
            if (heldObjectName == "IronKey")
            {
                ...
                StateAccessor.SetState("IronKey", "Idle", ironKey, "Version_5");
            }

            // Transition cauldron from Failed back to Empty so play can restart
            StateAccessor.SetState("Cauldron", "Empty", cauldron, "Version_5");
